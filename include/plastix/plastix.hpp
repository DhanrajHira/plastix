...
private:
  ...
  // inputs to this step's forward pass) and the other is being written
  // (CurrentActivation). This ensures each unit sees stable source values
  // from the previous step even as downstream units are updated.
