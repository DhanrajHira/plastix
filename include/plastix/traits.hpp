...
//
//   Phase 2 — Apply: called once per destination unit after all
//     its incoming Map results have been combined. Applies the activation
//     function, stores any side-effects (e.g. error signals).
